...
import { BATCH_1, BATCH_2, BATCH_3, BATCH_4, BATCH_5, BATCH_6 } from '../../src/teams/index.ts';
...
const BATCHES: { name: string; modules: KtTeamModule[]; seedBase: number }[] = [
  ...
  { name: 'batch-5', modules: BATCH_5, seedBase: 5000 },
  { name: 'batch-6', modules: BATCH_6, seedBase: 6000 },
];
