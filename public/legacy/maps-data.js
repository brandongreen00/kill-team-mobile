...
(function (root) {
  ...
  // --- Built-in maps ------------------------------------------------------
  //
  // Approved Ops layouts authored in the Map Creator and captured here so
  // they ship out-of-the-box. Use ./map-creator.html to author new ones;
  // user-saved maps live in localStorage under 'kt.customMaps' and merge
  // into the catalog via getMap().
